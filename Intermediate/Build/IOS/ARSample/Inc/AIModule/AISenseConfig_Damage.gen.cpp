...
// End Cross Module References
...
#endif
			static const UE4CodeGen_Private::FClassPropertyParams NewProp_Implementation = { UE4CodeGen_Private::EPropertyClass::Class, "Implementation", RF_Public|RF_Transient|RF_MarkAsNative, 0x0014000002014015, 1, nullptr, STRUCT_OFFSET(UAISenseConfig_Damage, Implementation), Z_Construct_UClass_UAISense_Damage_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(NewProp_Implementation_MetaData, ARRAY_COUNT(NewProp_Implementation_MetaData)) };
	...
	IMPLEMENT_CLASS(UAISenseConfig_Damage, 1990822678);
