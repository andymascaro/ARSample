...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_AIModule_EGenericAICheck_CRC() { return 351239984U; }
	...
	uint32 Get_Z_Construct_UEnum_AIModule_EAILockSource_CRC() { return 3795522777U; }
	...
	uint32 Get_Z_Construct_UEnum_AIModule_EAIRequestPriority_CRC() { return 570944238U; }
	...
	uint32 Get_Z_Construct_UEnum_AIModule_EPawnActionEventType_CRC() { return 3198696356U; }
	...
	uint32 Get_Z_Construct_UEnum_AIModule_EPawnActionResult_CRC() { return 3926290685U; }
	...
	uint32 Get_Z_Construct_UEnum_AIModule_EPawnActionAbortState_CRC() { return 4233401082U; }
	...
	uint32 Get_Z_Construct_UEnum_AIModule_FAIDistanceType_CRC() { return 3348069634U; }
	...
	uint32 Get_Z_Construct_UEnum_AIModule_EAIOptionFlag_CRC() { return 1460699539U; }
...
static struct FScriptStruct_AIModule_StaticRegisterNativesFAIMoveRequest
{
...
#endif
			auto NewStructOpsLambda = []() -> void* { return (UScriptStruct::ICppStructOps*)new UScriptStruct::TCppStructOps<FAIMoveRequest>(); };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_GoalActor = { UE4CodeGen_Private::EPropertyClass::Object, "GoalActor", RF_Public|RF_Transient|RF_MarkAsNative, 0x0020080000000000, 1, nullptr, STRUCT_OFFSET(FAIMoveRequest, GoalActor), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(NewProp_GoalActor_MetaData, ARRAY_COUNT(NewProp_GoalActor_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FAIMoveRequest_CRC() { return 1590359825U; }
...
static struct FScriptStruct_AIModule_StaticRegisterNativesFAIRequestID
{
...
#endif
			auto NewStructOpsLambda = []() -> void* { return (UScriptStruct::ICppStructOps*)new UScriptStruct::TCppStructOps<FAIRequestID>(); };
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_RequestID_MetaData[] = {
				{ "ModuleRelativePath", "Classes/AITypes.h" },
			};
#endif
			static const UE4CodeGen_Private::FUInt32PropertyParams NewProp_RequestID = { UE4CodeGen_Private::EPropertyClass::UInt32, "RequestID", RF_Public|RF_Transient|RF_MarkAsNative, 0x0040000000000000, 1, nullptr, STRUCT_OFFSET(FAIRequestID, RequestID), METADATA_PARAMS(NewProp_RequestID_MetaData, ARRAY_COUNT(NewProp_RequestID_MetaData)) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
	...
	uint32 Get_Z_Construct_UScriptStruct_FAIRequestID_CRC() { return 3229832578U; }
