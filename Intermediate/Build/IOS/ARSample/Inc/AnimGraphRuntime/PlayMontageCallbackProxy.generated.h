...
#define Engine_Source_Runtime_AnimGraphRuntime_Public_PlayMontageCallbackProxy_h_16_RPC_WRAPPERS \
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		this->OnNotifyEndReceived(Z_Param_NotifyName,Z_Param_Out_BranchingPointNotifyPayload); \
		P_NATIVE_END; \
	} \
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		this->OnNotifyBeginReceived(Z_Param_NotifyName,Z_Param_Out_BranchingPointNotifyPayload); \
		P_NATIVE_END; \
	} \
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		this->OnMontageEnded(Z_Param_Montage,Z_Param_bInterrupted); \
		P_NATIVE_END; \
	} \
 \
...
private: \
	...
	friend ANIMGRAPHRUNTIME_API class UClass* Z_Construct_UClass_UPlayMontageCallbackProxy(); \
public: \
	DECLARE_CLASS(UPlayMontageCallbackProxy, UObject, COMPILED_IN_FLAGS(0), 0, TEXT("/Script/AnimGraphRuntime"), ANIMGRAPHRUNTIME_API) \
