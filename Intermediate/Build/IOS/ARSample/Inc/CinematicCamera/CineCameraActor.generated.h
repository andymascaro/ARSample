...
#define Engine_Source_Runtime_CinematicCamera_Public_CineCameraActor_h_17_GENERATED_BODY \
	friend CINEMATICCAMERA_API class UScriptStruct* Z_Construct_UScriptStruct_FCameraLookatTrackingSettings(); \
...
#define Engine_Source_Runtime_CinematicCamera_Public_CineCameraActor_h_53_RPC_WRAPPERS \
 \
	...
	{ \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(UCineCameraComponent**)Z_Param__Result=this->GetCineCameraComponent(); \
		P_NATIVE_END; \
	}
...
private: \
	...
	friend CINEMATICCAMERA_API class UClass* Z_Construct_UClass_ACineCameraActor(); \
public: \
	DECLARE_CLASS(ACineCameraActor, ACameraActor, COMPILED_IN_FLAGS(0), 0, TEXT("/Script/CinematicCamera"), NO_API) \
