...
static struct FScriptStruct_Engine_StaticRegisterNativesFAnimNode_SaveCachedPose
{
...
#endif
			auto NewStructOpsLambda = []() -> void* { return (UScriptStruct::ICppStructOps*)new UScriptStruct::TCppStructOps<FAnimNode_SaveCachedPose>(); };
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_GlobalWeight_MetaData[] = {
				{ "ModuleRelativePath", "Classes/Animation/AnimNode_SaveCachedPose.h" },
			};
#endif
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_GlobalWeight = { UE4CodeGen_Private::EPropertyClass::Float, "GlobalWeight", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000002000, 1, nullptr, STRUCT_OFFSET(FAnimNode_SaveCachedPose, GlobalWeight), METADATA_PARAMS(NewProp_GlobalWeight_MetaData, ARRAY_COUNT(NewProp_GlobalWeight_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FNamePropertyParams NewProp_CachePoseName = { UE4CodeGen_Private::EPropertyClass::Name, "CachePoseName", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000000, 1, nullptr, STRUCT_OFFSET(FAnimNode_SaveCachedPose, CachePoseName), METADATA_PARAMS(NewProp_CachePoseName_MetaData, ARRAY_COUNT(NewProp_CachePoseName_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_Pose = { UE4CodeGen_Private::EPropertyClass::Struct, "Pose", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000005, 1, nullptr, STRUCT_OFFSET(FAnimNode_SaveCachedPose, Pose), Z_Construct_UScriptStruct_FPoseLink, METADATA_PARAMS(NewProp_Pose_MetaData, ARRAY_COUNT(NewProp_Pose_MetaData)) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_GlobalWeight,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_CachePoseName,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_Pose,
			};
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNode_SaveCachedPose_CRC() { return 2071336955U; }
