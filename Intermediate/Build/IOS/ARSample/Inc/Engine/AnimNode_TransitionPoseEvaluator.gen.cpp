...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Engine_EEvaluatorMode_CRC() { return 834708923U; }
	...
	uint32 Get_Z_Construct_UEnum_Engine_EEvaluatorDataSource_CRC() { return 606521933U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFAnimNode_TransitionPoseEvaluator
{
...
#endif
			auto NewStructOpsLambda = []() -> void* { return (UScriptStruct::ICppStructOps*)new UScriptStruct::TCppStructOps<FAnimNode_TransitionPoseEvaluator>(); };
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_CacheFramesRemaining_MetaData[] = {
				{ "ModuleRelativePath", "Classes/Animation/AnimNode_TransitionPoseEvaluator.h" },
			};
#endif
			static const UE4CodeGen_Private::FIntPropertyParams NewProp_CacheFramesRemaining = { UE4CodeGen_Private::EPropertyClass::Int, "CacheFramesRemaining", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000002000, 1, nullptr, STRUCT_OFFSET(FAnimNode_TransitionPoseEvaluator, CacheFramesRemaining), METADATA_PARAMS(NewProp_CacheFramesRemaining_MetaData, ARRAY_COUNT(NewProp_CacheFramesRemaining_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FIntPropertyParams NewProp_FramesToCachePose = { UE4CodeGen_Private::EPropertyClass::Int, "FramesToCachePose", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000005, 1, nullptr, STRUCT_OFFSET(FAnimNode_TransitionPoseEvaluator, FramesToCachePose), METADATA_PARAMS(NewProp_FramesToCachePose_MetaData, ARRAY_COUNT(NewProp_FramesToCachePose_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FBytePropertyParams NewProp_EvaluatorMode = { UE4CodeGen_Private::EPropertyClass::Byte, "EvaluatorMode", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000005, 1, nullptr, STRUCT_OFFSET(FAnimNode_TransitionPoseEvaluator, EvaluatorMode), Z_Construct_UEnum_Engine_EEvaluatorMode, METADATA_PARAMS(NewProp_EvaluatorMode_MetaData, ARRAY_COUNT(NewProp_EvaluatorMode_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FBytePropertyParams NewProp_DataSource = { UE4CodeGen_Private::EPropertyClass::Byte, "DataSource", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000005, 1, nullptr, STRUCT_OFFSET(FAnimNode_TransitionPoseEvaluator, DataSource), Z_Construct_UEnum_Engine_EEvaluatorDataSource, METADATA_PARAMS(NewProp_DataSource_MetaData, ARRAY_COUNT(NewProp_DataSource_MetaData)) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_CacheFramesRemaining,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_FramesToCachePose,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_EvaluatorMode,
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNode_TransitionPoseEvaluator_CRC() { return 3316727554U; }
