...
#define Engine_Source_Runtime_Engine_Classes_Kismet_GameplayStatics_h_40_RPC_WRAPPERS \
 ...
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(UParticleSystemComponent**)Z_Param__Result=UGameplayStatics::SpawnEmitterAttached(Z_Param_EmitterTemplate,Z_Param_AttachToComponent,Z_Param_AttachPointName,Z_Param_Location,Z_Param_Rotation,Z_Param_Scale,EAttachLocation::Type(Z_Param_LocationType),Z_Param_bAutoDestroy); \
		P_NATIVE_END; \
	} \
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(UParticleSystemComponent**)Z_Param__Result=UGameplayStatics::SpawnEmitterAtLocation(Z_Param_WorldContextObject,Z_Param_EmitterTemplate,Z_Param_Location,Z_Param_Rotation,Z_Param_Scale,Z_Param_bAutoDestroy); \
		P_NATIVE_END; \
	} \
 \
