...
#include "Classes/Materials/MaterialExpressionBentNormalCustomOutput.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// End Cross Module References
...
#endif
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_Input = { UE4CodeGen_Private::EPropertyClass::Struct, "Input", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000000, 1, nullptr, STRUCT_OFFSET(UMaterialExpressionBentNormalCustomOutput, Input), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(NewProp_Input_MetaData, ARRAY_COUNT(NewProp_Input_MetaData)) };
	...
	IMPLEMENT_CLASS(UMaterialExpressionBentNormalCustomOutput, 413020764);
