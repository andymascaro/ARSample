...
#include "Public/Slate/SGameLayerManager.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Engine_EWindowTitleBarMode_CRC() { return 1724685246U; }
	UEnum* Z_Construct_UEnum_Engine_EWindowTitleBarMode()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_Engine();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EWindowTitleBarMode"), 0, Get_Z_Construct_UEnum_Engine_EWindowTitleBarMode_CRC(), false);
#else
