...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Engine_ETimeStretchCurveMapping_CRC() { return 992934721U; }
	UEnum* Z_Construct_UEnum_Engine_ETimeStretchCurveMapping()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_Engine();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("ETimeStretchCurveMapping"), 0, Get_Z_Construct_UEnum_Engine_ETimeStretchCurveMapping_CRC(), false);
#else
...
class UScriptStruct* FTimeStretchCurveInstance::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern ENGINE_API uint32 Get_Z_Construct_UScriptStruct_FTimeStretchCurveInstance_CRC();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FTimeStretchCurveInstance, Z_Construct_UPackage__Script_Engine(), TEXT("TimeStretchCurveInstance"), sizeof(FTimeStretchCurveInstance), Get_Z_Construct_UScriptStruct_FTimeStretchCurveInstance_CRC());
	}
	return Singleton;
}
...
static struct FScriptStruct_Engine_StaticRegisterNativesFTimeStretchCurveInstance
{
	...
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FTimeStretchCurveInstance_CRC();
		UPackage* Outer = Z_Construct_UPackage__Script_Engine();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("TimeStretchCurveInstance"), sizeof(FTimeStretchCurveInstance), Get_Z_Construct_UScriptStruct_FTimeStretchCurveInstance_CRC(), false);
#else
...
#endif
			auto NewStructOpsLambda = []() -> void* { return (UScriptStruct::ICppStructOps*)new UScriptStruct::TCppStructOps<FTimeStretchCurveInstance>(); };
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bHasValidData_MetaData[] = {
				{ "ModuleRelativePath", "Classes/Animation/TimeStretchCurve.h" },
			};
#endif
			auto NewProp_bHasValidData_SetBit = [](void* Obj){ ((FTimeStretchCurveInstance*)Obj)->bHasValidData = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bHasValidData = { UE4CodeGen_Private::EPropertyClass::Bool, "bHasValidData", RF_Public|RF_Transient|RF_MarkAsNative, 0x0040000000002000, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(FTimeStretchCurveInstance), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bHasValidData_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bHasValidData_MetaData, ARRAY_COUNT(NewProp_bHasValidData_MetaData)) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bHasValidData,
			};
	...
	uint32 Get_Z_Construct_UScriptStruct_FTimeStretchCurveInstance_CRC() { return 1508169111U; }
class UScriptStruct* FTimeStretchCurve::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern ENGINE_API uint32 Get_Z_Construct_UScriptStruct_FTimeStretchCurve_CRC();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FTimeStretchCurve, Z_Construct_UPackage__Script_Engine(), TEXT("TimeStretchCurve"), sizeof(FTimeStretchCurve), Get_Z_Construct_UScriptStruct_FTimeStretchCurve_CRC());
	}
	return Singleton;
}
...
static struct FScriptStruct_Engine_StaticRegisterNativesFTimeStretchCurve
{
	...
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FTimeStretchCurve_CRC();
		UPackage* Outer = Z_Construct_UPackage__Script_Engine();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("TimeStretchCurve"), sizeof(FTimeStretchCurve), Get_Z_Construct_UScriptStruct_FTimeStretchCurve_CRC(), false);
#else
		static UScriptStruct* ReturnStruct = nullptr;
#endif
		if (!ReturnStruct)
...
#endif
			auto NewStructOpsLambda = []() -> void* { return (UScriptStruct::ICppStructOps*)new UScriptStruct::TCppStructOps<FTimeStretchCurve>(); };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_Sum_dT_i_by_C_i = { UE4CodeGen_Private::EPropertyClass::Float, "Sum_dT_i_by_C_i", RF_Public|RF_Transient|RF_MarkAsNative, 0x0040000000020001, CPP_ARRAY_DIM(Sum_dT_i_by_C_i, FTimeStretchCurve), nullptr, STRUCT_OFFSET(FTimeStretchCurve, Sum_dT_i_by_C_i), METADATA_PARAMS(NewProp_Sum_dT_i_by_C_i_MetaData, ARRAY_COUNT(NewProp_Sum_dT_i_by_C_i_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FArrayPropertyParams NewProp_Markers = { UE4CodeGen_Private::EPropertyClass::Array, "Markers", RF_Public|RF_Transient|RF_MarkAsNative, 0x0040000000020001, 1, nullptr, STRUCT_OFFSET(FTimeStretchCurve, Markers), METADATA_PARAMS(NewProp_Markers_MetaData, ARRAY_COUNT(NewProp_Markers_MetaData)) };
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_Markers_Inner = { UE4CodeGen_Private::EPropertyClass::Struct, "Markers", RF_Public|RF_Transient|RF_MarkAsNative, 0x0000000000020000, 1, nullptr, 0, Z_Construct_UScriptStruct_FTimeStretchCurveMarker, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_CurveValueMinPrecision = { UE4CodeGen_Private::EPropertyClass::Float, "CurveValueMinPrecision", RF_Public|RF_Transient|RF_MarkAsNative, 0x0040000000000001, 1, nullptr, STRUCT_OFFSET(FTimeStretchCurve, CurveValueMinPrecision), METADATA_PARAMS(NewProp_CurveValueMinPrecision_MetaData, ARRAY_COUNT(NewProp_CurveValueMinPrecision_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_SamplingRate = { UE4CodeGen_Private::EPropertyClass::Float, "SamplingRate", RF_Public|RF_Transient|RF_MarkAsNative, 0x0040000000000001, 1, nullptr, STRUCT_OFFSET(FTimeStretchCurve, SamplingRate), METADATA_PARAMS(NewProp_SamplingRate_MetaData, ARRAY_COUNT(NewProp_SamplingRate_MetaData)) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_Sum_dT_i_by_C_i,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_Markers,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_Markers_Inner,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_CurveValueMinPrecision,
	...
	uint32 Get_Z_Construct_UScriptStruct_FTimeStretchCurve_CRC() { return 3291854632U; }
class UScriptStruct* FTimeStretchCurveMarker::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern ENGINE_API uint32 Get_Z_Construct_UScriptStruct_FTimeStretchCurveMarker_CRC();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FTimeStretchCurveMarker, Z_Construct_UPackage__Script_Engine(), TEXT("TimeStretchCurveMarker"), sizeof(FTimeStretchCurveMarker), Get_Z_Construct_UScriptStruct_FTimeStretchCurveMarker_CRC());
	}
	return Singleton;
}
...
static struct FScriptStruct_Engine_StaticRegisterNativesFTimeStretchCurveMarker
{
	...
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FTimeStretchCurveMarker_CRC();
		UPackage* Outer = Z_Construct_UPackage__Script_Engine();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("TimeStretchCurveMarker"), sizeof(FTimeStretchCurveMarker), Get_Z_Construct_UScriptStruct_FTimeStretchCurveMarker_CRC(), false);
#else
		static UScriptStruct* ReturnStruct = nullptr;
#endif
		if (!ReturnStruct)
...
#endif
			auto NewStructOpsLambda = []() -> void* { return (UScriptStruct::ICppStructOps*)new UScriptStruct::TCppStructOps<FTimeStretchCurveMarker>(); };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_Alpha = { UE4CodeGen_Private::EPropertyClass::Float, "Alpha", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000020001, 1, nullptr, STRUCT_OFFSET(FTimeStretchCurveMarker, Alpha), METADATA_PARAMS(NewProp_Alpha_MetaData, ARRAY_COUNT(NewProp_Alpha_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_Time = { UE4CodeGen_Private::EPropertyClass::Float, "Time", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000020001, CPP_ARRAY_DIM(Time, FTimeStretchCurveMarker), nullptr, STRUCT_OFFSET(FTimeStretchCurveMarker, Time), METADATA_PARAMS(NewProp_Time_MetaData, ARRAY_COUNT(NewProp_Time_MetaData)) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
	...
	uint32 Get_Z_Construct_UScriptStruct_FTimeStretchCurveMarker_CRC() { return 2609504258U; }
