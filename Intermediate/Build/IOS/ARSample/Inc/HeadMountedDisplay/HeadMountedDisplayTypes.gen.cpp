...
#include "Public/HeadMountedDisplayTypes.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_HeadMountedDisplay_ESpectatorScreenMode_CRC() { return 2345903733U; }
	UEnum* Z_Construct_UEnum_HeadMountedDisplay_ESpectatorScreenMode()
	{
		...
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("ESpectatorScreenMode"), 0, Get_Z_Construct_UEnum_HeadMountedDisplay_ESpectatorScreenMode_CRC(), false);
#else
	...
	uint32 Get_Z_Construct_UEnum_HeadMountedDisplay_EHMDWornState_CRC() { return 1699531940U; }
	UEnum* Z_Construct_UEnum_HeadMountedDisplay_EHMDWornState()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_HeadMountedDisplay();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EHMDWornState"), 0, Get_Z_Construct_UEnum_HeadMountedDisplay_EHMDWornState_CRC(), false);
#else
		static UEnum* ReturnEnum = nullptr;
#endif // WITH_HOT_RELOAD
		if (!ReturnEnum)
	...
	uint32 Get_Z_Construct_UEnum_HeadMountedDisplay_EHMDTrackingOrigin_CRC() { return 1789300827U; }
	UEnum* Z_Construct_UEnum_HeadMountedDisplay_EHMDTrackingOrigin()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_HeadMountedDisplay();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EHMDTrackingOrigin"), 0, Get_Z_Construct_UEnum_HeadMountedDisplay_EHMDTrackingOrigin_CRC(), false);
#else
		static UEnum* ReturnEnum = nullptr;
#endif // WITH_HOT_RELOAD
		if (!ReturnEnum)
	...
	uint32 Get_Z_Construct_UEnum_HeadMountedDisplay_EOrientPositionSelector_CRC() { return 1556375878U; }
	UEnum* Z_Construct_UEnum_HeadMountedDisplay_EOrientPositionSelector()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_HeadMountedDisplay();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EOrientPositionSelector"), 0, Get_Z_Construct_UEnum_HeadMountedDisplay_EOrientPositionSelector_CRC(), false);
#else
		static UEnum* ReturnEnum = nullptr;
#endif // WITH_HOT_RELOAD
		if (!ReturnEnum)
