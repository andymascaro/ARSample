...
#define Engine_Source_Runtime_MediaAssets_Public_MediaPlaylist_h_20_RPC_WRAPPERS \
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(bool*)Z_Param__Result=this->Replace(Z_Param_Index,Z_Param_Replacement); \
		P_NATIVE_END; \
	} \
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(bool*)Z_Param__Result=this->RemoveAt(Z_Param_Index); \
		P_NATIVE_END; \
	} \
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(bool*)Z_Param__Result=this->Remove(Z_Param_MediaSource); \
		P_NATIVE_END; \
	} \
 \
 ...
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		this->Insert(Z_Param_MediaSource,Z_Param_Index); \
		P_NATIVE_END; \
	} \
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(UMediaSource**)Z_Param__Result=this->GetRandom(Z_Param_Out_OutIndex); \
		P_NATIVE_END; \
	} \
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(UMediaSource**)Z_Param__Result=this->GetPrevious(Z_Param_Out_InOutIndex); \
		P_NATIVE_END; \
	} \
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(UMediaSource**)Z_Param__Result=this->GetNext(Z_Param_Out_InOutIndex); \
		P_NATIVE_END; \
	} \
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(UMediaSource**)Z_Param__Result=this->Get(Z_Param_Index); \
		P_NATIVE_END; \
	} \
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(bool*)Z_Param__Result=this->AddUrl(Z_Param_Url); \
		P_NATIVE_END; \
	} \
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(bool*)Z_Param__Result=this->AddFile(Z_Param_FilePath); \
		P_NATIVE_END; \
	} \
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(bool*)Z_Param__Result=this->Add(Z_Param_MediaSource); \
		P_NATIVE_END; \
	}
...
private: \
	...
	friend MEDIAASSETS_API class UClass* Z_Construct_UClass_UMediaPlaylist(); \
public: \
	DECLARE_CLASS(UMediaPlaylist, UObject, COMPILED_IN_FLAGS(0), 0, TEXT("/Script/MediaAssets"), NO_API) \
