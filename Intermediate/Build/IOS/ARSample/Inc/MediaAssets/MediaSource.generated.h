...
#define Engine_Source_Runtime_MediaAssets_Public_MediaSource_h_29_RPC_WRAPPERS \
 \
	...
	{ \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(bool*)Z_Param__Result=this->Validate(); \
		P_NATIVE_END; \
	} \
 \
...
private: \
	...
	friend MEDIAASSETS_API class UClass* Z_Construct_UClass_UMediaSource(); \
public: \
	DECLARE_CLASS(UMediaSource, UObject, COMPILED_IN_FLAGS(CLASS_Abstract), 0, TEXT("/Script/MediaAssets"), NO_API) \
