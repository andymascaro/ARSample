...
// End Cross Module References
...
#endif
			static const UE4CodeGen_Private::FArrayPropertyParams NewProp_Sections = { UE4CodeGen_Private::EPropertyClass::Array, "Sections", RF_Public|RF_Transient|RF_MarkAsNative, 0x0040008000000008, 1, nullptr, STRUCT_OFFSET(UMovieSceneMaterialTrack, Sections), METADATA_PARAMS(NewProp_Sections_MetaData, ARRAY_COUNT(NewProp_Sections_MetaData)) };
	...
	IMPLEMENT_CLASS(UMovieSceneMaterialTrack, 2282242213);
...
#endif
			static const UE4CodeGen_Private::FIntPropertyParams NewProp_MaterialIndex = { UE4CodeGen_Private::EPropertyClass::Int, "MaterialIndex", RF_Public|RF_Transient|RF_MarkAsNative, 0x0040000000000000, 1, nullptr, STRUCT_OFFSET(UMovieSceneComponentMaterialTrack, MaterialIndex), METADATA_PARAMS(NewProp_MaterialIndex_MetaData, ARRAY_COUNT(NewProp_MaterialIndex_MetaData)) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
	...
	IMPLEMENT_CLASS(UMovieSceneComponentMaterialTrack, 4065374887);
