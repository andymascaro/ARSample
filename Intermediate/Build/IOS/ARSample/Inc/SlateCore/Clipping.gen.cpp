...
#include "Public/Layout/Clipping.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_SlateCore_EWidgetClipping_CRC() { return 454914076U; }
	UEnum* Z_Construct_UEnum_SlateCore_EWidgetClipping()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_SlateCore();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EWidgetClipping"), 0, Get_Z_Construct_UEnum_SlateCore_EWidgetClipping_CRC(), false);
#else
